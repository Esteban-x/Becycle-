 ...
 */
final class Version20190423095250 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD id_adress_id INT DEFAULT NULL, DROP id_user, CHANGE id_address id_user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD tag_id INT DEFAULT NULL, ADD visible INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD actif INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD id_user INT NOT NULL, ADD id_address INT DEFAULT NULL, DROP id_user_id, DROP id_adress_id');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD12469DE2');
        $this->addSql('DROP INDEX IDX_D34A04AD12469DE2 ON product');
        $this->addSql('DROP INDEX IDX_D34A04ADBAD26311 ON product');
        $this->addSql('ALTER TABLE product DROP category_id, DROP tag_id, DROP visible');
