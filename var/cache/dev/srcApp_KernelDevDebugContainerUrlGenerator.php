...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'adresse_new' => [[], ['_controller' => 'App\\Controller\\AccountController::addAddress'], [], [['text', '/adresse/new']], [], []],
        'account_orders' => [[], ['_controller' => 'App\\Controller\\AccountController::AccOrders'], [], [['text', '/account/orders']], [], []],
        'account_orders_show' => [['order'], ['_controller' => 'App\\Controller\\AccountController::AccOrdersShow'], [], [['variable', '/', '[^/]++', 'order', true], ['text', '/account/orders']], [], []],
