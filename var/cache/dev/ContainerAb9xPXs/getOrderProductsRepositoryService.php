...
// Returns the private 'App\Repository\OrderProductsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OrderProductsRepository.php';

return $this->privates['App\Repository\OrderProductsRepository'] = new \App\Repository\OrderProductsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
